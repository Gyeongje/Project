...
void menu()
{
	...
	cout << "+---------------------------------+" << endl;
	cout << "| KhuArchive <Command> <Filename> |" << endl;
	cout << "+---------------------------------+" << endl;
	cout << "| Command:                        |" << endl;
	...
	cout << "+---------------------------------+" << endl;
	cout << "| Example:                        |" << endl;
	cout << "|    KhuArchive append  <File>    |" << endl;
	cout << "|    KhuArchive list              |" << endl;
	cout << "|    KhuArchive Extract <File>    |" << endl;
	cout << "+---------------------------------+" << endl;
	cout << endl;
}
...
int main(int argc, char* argv[])
{
    ...
    if (argc < 2 || argc > 3)
    {
		cout << "Plz Input <Command> <Filename>" << endl;
        return 0;
    }

	char command_[CMAX] = { 0, };
	char filename_[FMAX] = { 0, };
